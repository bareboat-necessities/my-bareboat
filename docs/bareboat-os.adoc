...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-05-09
...
- Turn on 'Large Text', set 'Cursor Size' to 'Medium' (Or go into Budgie Desktop Preferences and change font scaling there)
