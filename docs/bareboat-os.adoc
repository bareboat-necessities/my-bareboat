...
:description: BBN Marine OS is a free and open source Linux for boats and raspberry pi \
With BBN OS you can build a chartplotter including OpenCPN, SignalK, NMEA similar to openplotter
:doctype: book
