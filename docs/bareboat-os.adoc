...
That should create a CAN Bus network interface after reboot. It's same type of interface you would see with ifconfig command.
...
After that you should be able too some data from CAN Bus using:
