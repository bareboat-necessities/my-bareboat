...
Create an account on realvnc.com web site. Login from your pi's RealVNC server into
realvnc.com cloud using the account you set up. Set-up a password on your pi's VNC server for
users to connect. While being logged in into realvnc.com web site create a team and invite
people you want to have a remote desktop access to your pi. When they accept your invite
