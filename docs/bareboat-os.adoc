...
- Enable 'IMU only' pypilot service

[source, shell]
----
sudo systemctl enable pypilot_boatimu
sudo systemctl start pypilot_boatimu
----

- At this point you should be able to see reading of pitch/roll, etc, and magnetic heading.
