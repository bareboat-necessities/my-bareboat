...
BBN OS supports NVMe and SATA with an appropriate extension board, or a Pi case, and
their vendor's driver.

NVMe apparently doesn't give much performance boost over SATA for pi4 with
exception of CM4 (Pi4 Compute Module) performing better on writes with NVMe drives.
