...
https://archive.org/details/lysmarine-bbn-linux-LTS3
...
- Raymarine Autohelm SeaTalk autopilots can be controlled by SignalK plugin.
...
There are sometimes timing issues with USB ports during first boot. If you see touchscreen not being calibrated
then try (fter establishing Internet connectivity and with touchscreen properly connected):
