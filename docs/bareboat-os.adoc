...
For SignalK support visit: https://discord.com/invite/cpGqA5sZ
...
PyPilot comes with a calibration utility. During calibration you need to rotate IMU along all axises to 
allow calibration process to assess ranges of readings and skew bias on each of them. Calibration process completes when its able to optimally
