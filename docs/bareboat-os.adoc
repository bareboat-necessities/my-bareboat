...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-04-23

Past LTS release:

https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-03-30
...
your monitor in /boot/config.txt
