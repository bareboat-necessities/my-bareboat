...
Documentaiton on setting it up and using it:
...
and selecting booting into console under System Options / Boot - Auto Login.
...
Even without autopilot servo these sensors allow displaying; roll, pitch, and yaw.
...
- NASA Marine PC Navtex USB with antenna. ~$220
