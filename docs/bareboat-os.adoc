...
with disk benchmarking tool. Good SD card would show about 42 MB/sec (or higher) read i/o speed in it.
SSD drives would show much better results: 145 MB/sec read and 135 MB/sec write i/o speed or higher.
...
Power usage might be relatively high for really small boats.
