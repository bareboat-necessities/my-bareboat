...
NOTE: If you use Waveshare board and your CM4 module comes with eMMC then you can't boot from SD card and you have
...
line into /boot/config.txt on the image.
