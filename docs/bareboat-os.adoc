...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2024-09-18
...
IMU magnetometer is EXTREMELY sensitive. Even putting your hand next to it can change heading by 5-10 degrees.
Make sure you very carefully pick a place on the boat for it, way away from currents and magnetic metal objects.
Pack it in a relatively big plastic enclosure.
...
Edit /usr/local/share/applications/victron.desktop file
