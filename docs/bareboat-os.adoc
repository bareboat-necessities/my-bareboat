...
In most cases you just need to enable USB debugging on your Android device and plug it in.
...
udp    5353       service discovery    chromium, others (bonjour, zeroconf, mDNS)
udp    10116      NMEA 0183            AvNav, KPlex
udp    40334      mDNS                 avahi-daemon
udp    46572      mDNS                 avahi-daemon
