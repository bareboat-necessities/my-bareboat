...
Iris is an alernative player to MusicBox. Iris is also included in the BBN OS image.
...
* http://lysmarine:6680 Mopidy MusicBox/Iris
...
If you use your devices on WiFi networks they might get assigned different IP addresses from DHCP servers.
...
Printing from Chromium is a bit unconvenient. You need to choose 'Print' menu, then
...
==== How to navigate with your iPhone as GPS receiver and have an Internet access on a boat within cellular reception
...
* Follow steps <<tether>> to connect to your phone and use it as an Internet hotspot.
