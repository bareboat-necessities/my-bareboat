...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-06-23
...
PyPilot HAT is optional. It provides a remote IR control and a small LCD display.
