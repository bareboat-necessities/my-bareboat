...
Download SD card image (~3Gb file):
...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-02-10

Past LTS release:

https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-01-30
