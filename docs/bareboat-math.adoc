...
Could difference in phase between acceleration and pitch give more hit to set initial
speed so the algorithm can converge faster?

Does pitch(t) and slope s(t) follow same phase?
