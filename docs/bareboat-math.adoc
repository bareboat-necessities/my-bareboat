...
stem:[h(t) = int v(t) dt = - ln (H k cos(c k t) + 1) / k + const]
...
stem:[a_max = g / (1 + e^(-(2pib)/L)) ]

stem:[a_min = g / (1 - e^(-(2pib)/L)) ]

stem:[b(a_max) = - L / (2 pi) ln( g / (a_max) - 1)]

stem:[b(a_min) = - L / (2 pi) ln( 1 - g / (a_min))]
...
stem:[Delta v=v_{\text{s})] {nbsp}  is the opposite of the velocity of the receiver
...
stem:[L_s] {nbsp} is source wavelength (m) for trochoidal wave:
