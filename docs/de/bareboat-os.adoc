...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-09-09
...
Schreibe das Image wie es ist auf die SD-Karte. Do not change default user on the image by RPI imager advanced settings.
