...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-10-01
...
Install avrdude using this script:

https://github.com/bareboat-necessities/my-bareboat/blob/master/avrdude/avrdude-install.sh
