...
https://github.com/bareboat-necessities/lysmarine_gen/releases/tag/v2022-09-26
...
NOTE: After calibration give pypilot 2-3 mins to run without restart to store settings.
...
Additional IMU and sensors settings adjustments are stored in /RTIMULib.ini file.
