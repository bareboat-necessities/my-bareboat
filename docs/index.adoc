...
sudo cp /home/pi/.config/mopidy/mopidy.conf /var/lib/mopidy/.config/mopid
----

Reboot.

You should later create a menu link to open Mopidy Web UI directly from desktop menu via this command:
...
[source, shell]
----
chromium-browser -new-window http://openplotter:6680/musicbox_webclient; sleep 3; xdotool key F11
----
