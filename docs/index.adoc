...
https://github.com/bareboat-necessities/lysmarine_gen[Bareboat Necessities Marine Linux OS for Raspberry Pi]
...
* Off-shore features, Climatology/Weather Routing/Weather Fax/GRIB/Celestial Navigation/DIY Autopilots/PyPilot (by Sean D'Pagnier)
...
* Many others who build core protocol/sensor/data formats libraries
