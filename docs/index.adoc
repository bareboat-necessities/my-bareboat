...
Exec=sh -c "chromium-browser -new-window http://localhost:8099; sleep 5; xdotool key F11"
Terminal=false
Icon=globe
...
Exec=sh -c "chromium-browser -new-window http://localhost:3000/@signalk/freeboard-sk; sleep 5; xdotool key F11"
Terminal=false
Icon=globe
Categories=Navigation;ChartPlotter
Keywords=Navigation;ChartPlotter
...
Exec=sh -c "chromium-browser -new-window http://localhost:3000/tuktuk-chart-plotter; sleep 5; xdotool key F11"
Terminal=false
Icon=globe
Categories=Navigation;ChartPlotter
Keywords=Navigation;ChartPlotter
...
Exec=sh -c "chromium-browser -new-window http://localhost:3000/@mxtommy/kip; sleep 5; xdotool key F11"
Terminal=false
Icon=globe
...
Exec=sh -c "chromium-browser -new-window http://openplotter:6680/musicbox_webclient; sleep 5; xdotool key F11"
Terminal=false
Icon=sound
