...
This is a nice char plotter which runs in a browser supports number of chart formats (You need to convert them though
...
if you do not have xdotool install it
...
You can use mbtiles which you downloaded for OpenCPN. AvNav need to convert them first.
To convert:
