...
This document describes a DIY project of building a marine computer, a marine LTE/WiFi gateway, and
...
* LTE / 4G Gateway
* WiFi hotspot and router with WiFi extender and long range waterproof WiFi antenna
...
The computer is connected to the waterproof HDMI touchscreen in the cockpit.

=== Boat Computer

The boat computer runs on Raspberry Pi (Raspbian Linux) with OpenPlotter 2.0 installed. The computer will reside
below deck so it's not going to be waterproof. The touchscreen displays OpenPlotter UI with OpenCPN chart plotter and
dashboards as well as general Linux UI.

*Boat Computer Front View*
...
The second box is an extension to the boat computer. It is connected to it via Ethernet.
It uses the same type of an enclosure as the boat computer.
...
.Router Front Panel View
image::boat-router/router-front-panel-1.jpg[alt="Router Front Panel View", width="75%", align="center"]

{zwsp} +

.Router Front Panel Wiring
image::boat-router/router-front-panel-2.jpg[alt="Router Front Panel Wiring", width="75%", align="center"]
...
.Router Back Panel View
image::boat-router/router-back-panel-1.jpg[alt="Router Back Panel View", width="75%", align="center"]

{zwsp} +

.Router Back Panel Wiring
image::boat-router/router-back-panel-2.jpg[alt="Router Back Panel Wiring", width="75%", align="center"]
...
.Router Inside
image::boat-router/router-inside.jpg[alt="Router Inside", width="75%", align="center"]

{zwsp} +

.Router Inside Top
image::boat-router/router-inside-1.jpg[alt="Router Inside Top", width="75%", align="center"]

{zwsp} +

.Router Inside Bottom
image::boat-router/router-inside-2.jpg[alt="Router Inside Bottom", width="75%", align="center"]
