...
* WiFi Gateway (connecting to marina's WiFi and on-shore WiFi hot-spots via long range WiFi antenna)

* LTE / 4G Gateway (providing a boat with the internet and voice access within the zone of reception
...
* M5Stack ESP32 Controller and 3-Buttons LCD display (panel mounted) (with numerous optional M2Stack add-ons)
...
operating system but very capable of running complex programs
