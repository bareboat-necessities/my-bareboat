...
the spirit of open source development. We hope this design is going to evolve have numerous releases and corrections
if it gains some community. Some software components might become part of this too.
