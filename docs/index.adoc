...
.Boat Computer, Inside View
image::computer-internals.jpg[alt="Boat Computer, Inside View", width="75%",  pdfwidth="75vw", align="center"]
...
.Basic Installation Steps
ifdef::env-github[image::basic-install-steps.svg[Basic Installation Steps, width="75%"]]
ifndef::env-github[]
