...
See: https://github.com/bareboat-necessities/my-bareboat/blob/master/onboard/onboard-install-rpi.sh
...
* https://gdal.orgindex.html/[GDAL documentation]
...
* https://github.com/redpesk-marine[RedPesk Marine]
