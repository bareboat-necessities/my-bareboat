...
EP06-A has 3 antenna connectors. One is connected to internal GPS antenna, another one to
...
Probably I should have connected external GPS antenna too. From my understanding if this modem
...
The modem is controlled via 'AT' commands. I couldn't find the command to check GPS status on the modem.
