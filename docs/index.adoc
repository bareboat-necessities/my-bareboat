...
NOTE: Unfortunately power supply which comes with ZeroBreeze is not waterproof (I do not know why they would
build a tent A/C with no waterproof power supply). And it broke right away. I had
to replace it with:
