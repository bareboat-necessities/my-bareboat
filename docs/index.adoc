...
|04 | Chesapeake and Delaware Bays===== NOAA Nautical Chart MBTiles
|06 | Norfolk, VA to Florida - The Intracoastal Waterway
|07 | Florida East Coast and the KeysAdditionally, you can use links for MBtiles from here:
|08 | Florida West Coast and the Keys
|10 | Puerto Rico and US Virgin Islandshttps://github.com/vokkim/noaa-nautical-charts
|12 | Southern California - Point Arena to Mexican Border
|13 | Lake MichiganThis is a list of available NOAA quilted nautical chart tilesets in MBTiles format.
|14 | San Francisco to Cape FlatteryFor the original NOAA Chart Tile Service please visit http://tileservice.charts.noaa.gov/
|15 | Pacific NorthWest - Puget Sound to Canadian Border
|17 | Mobile, AL to Mexican Border
|22 | Lake Superior and Lake Huron.Map of tileset sections
|24 | Lake Erie (US Waters)image::https://raw.githubusercontent.com/vokkim/noaa-nautical-charts/master/map.jpg[Map of tileset sections, width="75%",  pdfwidth="75vw", align="center"]
|26 | Lake Ontario (US Waters)
|30 | Southeast Alaska
|32 | South Central Alaskahttp://tileservice.charts.noaa.gov/tileset.html#50000_1-locator[NOAA Tileset locator]
|34 | Alaska - The Aleutians and Bristol Bay
|36 | Alaska - Norton Sound to Beaufort Seahttps://tileservice.charts.noaa.gov/#usage-policy[NOAA Chart Tile Service Usage policy]
|40 | Hawaiian Islands
|===
...
Decoder software for NavText is available here. Download the Java version to work on raspberry pi.
...
I've installed and played with it and I have found it it too difficult to use on a small cockpit touchscreen.
...
You can connect NMEA to your boat computer or
...
You should later register mopidy as a service to start automatically and create a menu
link to open Mopidy Web UI directly from desktop menu.
