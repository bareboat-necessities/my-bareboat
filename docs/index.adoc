...
if they are not powered off before the reboot and backfeed power into Pi or
it could be because I'm booting from USB flashdrive instead of SD card or due to USB controller (VL805) firmware.
...
there are 2  self powered hubs need to be isolated. The procedure is actually simpler than it sounds and it
makes the whole set up even safer. You do not want extra circuits running from below deck into the cockpit when cockpit
switch is 'off'. Power savings when you turn cockpit off are impressive. Pi takes 0.00-0.09 amps @ 12v with no HDMI
video connected (only USB connected sensors). For the cockpit USB 3.0 hub I got the shortest USB 3.0 type A
male to female cable. And for the computer's hub I've just taped it inside raspberry Pi USB 3.0 type A female part.
This is how it was done:

.USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation
image::boat-computer/usb-hub-isolation.jpg[alt="USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation", width="75%", align="center"]
...
.Test Setup
image::boat-computer/boat-network-testbed.jpg[alt="Test Setup", width="75%", align="center"]

{zwsp} +

.Cockpit Temporary Testbed
image::boat-computer/cockpit-temp-testbed.jpg[alt="Cockpit Temporary Testbed", width="75%", align="center"]
