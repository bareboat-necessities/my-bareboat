...
.NMEA Wiring Colors
image::nmea-wiring-colors.jpg[alt="NMEA Wiring Colors", width="75%", pdfwidth="75vw", align="center"]

{zwsp} +

Looking at the back side from the back
{zwsp} +
...
image::nmea-pins.jpg[alt="NMEA Pins 1,2,3,4,5 (1 is left, 5 is right)", width="75%", pdfwidth="75vw", align="center"]
