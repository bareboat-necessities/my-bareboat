...
image::boat-router/router-front-panel-1.jpg[alt="Router Front Panel View", width="50%", align="center"]

{zwsp} +

[.text-center]
.Router Front Panel Wiring
image::boat-router/router-front-panel-2.jpg[alt="Router Front Panel Wiring", width="50%", align="center"]
