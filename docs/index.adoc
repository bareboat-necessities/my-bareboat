...
Comment=ChartPlotter
Exec=sh -c "chromium-browser -new-window http://localhost:8099; sleep 2; xdotool key F11"
Terminal=false
Icon=globe
Categories=ChartPlotter,OpenPlotter
Keywords=ChartPlotter,OpenPlotter
EOF'
...
make sure you add 2 lines:

 cp /home/pi/.config/mopidy/mopidy.conf /etc/mopidy/mopidy.conf
 cp /home/pi/.config/mopidy/mopidy.conf /var/lib/mopidy/.config/mopidy/mopidy.conf

like this (on service startup)
...
Exec=sh -c "chromium-browser -new-window http://openplotter:6680/musicbox_webclient; sleep 2; xdotool key F11"
Terminal=false
Icon=sound
Categories=Sound
Keywords=Sound
