...
NOTE: There might be a better choice: "100KHz-1.7GHz Full Band UV HF RTL-SDR USB Tuner Receiver R820T+8232U Ham Radio"
on AliExpress and other stores. It has 2 antenna connectors one for HF 100KHz~30MHz band and another one for
