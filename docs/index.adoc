...
There are two dashbaord plugins with overlapping functionality.
One is Dassboard Plugin and another one is Dashboard Tactics Plugin. It seems
Dashboard Tactics Plugin is going to be better choice for long term.
