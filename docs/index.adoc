...
Saving it as a template in OPenCPN was a bit tricky in 7" screen as OpenCPN window is too big to see 'OK' button.
I had to press Ctrl-Tab twice followed by Enter.
