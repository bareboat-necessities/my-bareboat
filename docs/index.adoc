...
[source, shell]
----
sudo apt-get install build-essential libsoapysdr0.6 libsoapysdr-dev libopenal-dev \
 libliquid-dev freeglut3 freeglut3-dev libalut0 libalut-dev
...
FlDigi has decoders for used in marine communications SitorB/NavTex, RTTY, WeFax, CW, etc
