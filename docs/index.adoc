...
male to female cable. And for the computer's hub I've just taped it inside USB 3.0 type-A male part connecting the hub.
This is how it was done:

.USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation male
image::boat-computer/usb-hub-isolation-male.jpg[alt="USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation male", width="75%", align="center"]

{zwsp} +

.USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation female
image::boat-computer/usb-hub-isolation-female.jpg[alt="USB 3.0 Self-Powered Hub Backfeed and Forward-feed power isolation female", width="75%", align="center"]
