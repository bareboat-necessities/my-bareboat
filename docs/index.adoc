...
Argonaut M7 gen2 7-inch touch display stays under 10 watts. The display starts with maximum brightness.
...
so it is all usable amps) will give you 80*12/10=96 hours of chartplotting at max brightness. C'est la vie.
...
Another issue is entering the text on a touchscreen. I've added virtual on screen keyboard. I've compared
