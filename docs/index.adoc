...
* gpu_mem=512 reserves 512Mb of memory to graphic video card.
...
start giving AIS targets sentences via NMEA. If it doesn't see any ships close it doesn't send any sentences.
