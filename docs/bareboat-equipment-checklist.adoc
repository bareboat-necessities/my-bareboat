...
NOTE: Store items in plastic transparent zip lock bags (Easy to see). Expect everything to get wet, corrode, leak, spill,
tip over. Remove all packaging and stickers. Do not use carton boxes.
...
. Spare gas for stove
. Oil Lantern, liquid for it, funnel (or candle lantern)
. Plastic wire ties
. Garbage bags
. Paper towels
. Boat wash soap
