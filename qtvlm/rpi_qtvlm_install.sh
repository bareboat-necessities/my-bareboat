...
cd /home/user
echo "Downloading..."
wget -q -O - "https://www.meltemus.com/index.php/en/download?task=download.send&id=365&catid=9&m=0" > qtVlm-5.10.7-rpi.tar.gz
gzip -cd < qtVlm-5.10.7-rpi.tar.gz | tar xvf -
