...
char* nmea_sources[] = {"openplotter", "openplotter.local", "lysmarine", "lysmarine.local", "gl-x750"};
...
void setup() {
  ...
  nmea_source_begin();
  ez.settings.menuObj.addItem("NMEA wind talker", nmea_wind_talker_menu);
  nmea_wind_talker_begin();
  ez.begin();
}
